...
<head>
    ...
    @yield('head')
    <link
        href="/assets/common/vendor/bootstrap-select/dist/css/bootstrap-select.min.css"
        rel="stylesheet"
    />
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            @if (!Auth::user()->agreement)
                @include('niftyassistant.agreement')
            @else
                @yield('content')
            @endif
        </div>
    </div>
    @include('niftyassistant.footer')
</div>
<!--**********************************
    Main wrapper end
***********************************-->
